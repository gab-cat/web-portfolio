        ...
        >
          ...
          <motion.div variants={cardVariants}>
            {projects.map((project) => (
              ...
              >
                <Card className="bg-white/5 border-white/10 backdrop-blur-sm overflow-hidden holographic-card group">
                    ...
                    <div className="grid lg:grid-cols-2 gap-0 relative z-20">
                      ...
                      <div className="p-8 space-y-6">
                        ...
                        <div className="flex gap-4 pt-4">
                          <Button
                            asChild
                            className="liquid-button bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700"
                          >
                          ...
                          <Button variant="outline" asChild className="border-white/20 text-gray-900 hover:bg-white/10">
          ...
          <motion.div variants={itemVariants}>
            <h3 className="text-2xl font-heading font-bold text-white mb-6 text-center">Other Notable Projects</h3>
